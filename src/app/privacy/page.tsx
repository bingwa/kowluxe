    ...
    return (
      <div className="min-h-screen bg-cream py-24 px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-sm text-gray-600 mb-8">Last updated: November 9, 2025</p>
  
          <div className="space-y-6 text-charcoal leading-relaxed">
            <section>
              <h2 className="text-2xl font-heading font-semibold mb-4">1. About Us</h2>
              <p>
                kowluxé ("we", "us", or "our") operates the kowluxe.com website. This Privacy Policy 
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li><strong>Transaction Data:</strong> Payment details, shipping address, and order history</li>
                <li><strong>Communication Data:</strong> Information in emails, contact forms, or other correspondence with us</li>
              </ul>
            ...
            <section>
              <h2 className="text-2xl font-heading font-semibold mb-4">4. Cookies</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-heading font-semibold mb-4">5. Information Sharing</h2>
            ...
            <section>
              <h2 className="text-2xl font-heading font-semibold mb-4">8. Data Retention</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-heading font-semibold mb-4">10. Changes to This Policy</h2>
              <p>
